    ...
    <section className="py-16">
      <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div className="">
          ...
          <div className="sm:flex space-y-3 my-8 sm:space-y-0 gap-6 items-center">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold text-emerald-800 dark:text-amber-500">Free Intregation</h1>
              <p className="mt-2 w-[70%]">
                Easily connect with your existing tools and services at no extra cost
              </p>
            </div>
          </div>
          <div className="sm:flex space-y-3 my-8 sm:space-y-0 gap-6 items-center">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold text-emerald-800 dark:text-amber-500">Premium Resources</h1>
              <p className="mt-2 w-[70%]">
                Get access to top-tier design systems, code libraries, and expert support
              </p>
            </div>
          </div>
          <div className="sm:flex space-y-3 my-8 sm:space-y-0 gap-6 items-center">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold text-emerald-800 dark:text-amber-500">Unlimited Supports</h1>
              <p className="mt-2 w-[70%]">
        ...
        <div className="lg:ml-auto">
            <Image src='/hero.jpg' alt="Why Choose" width={500} height={500} className="rounded-lg" />
        </div>
